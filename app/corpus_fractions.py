...
def build_fraction_plan(
    ...
    """Build the exact `matverse.corpus-fractions.v1` structural plan.

    This is deliberately semantic-free. Membership and canonical ordering must be
    established before calling this function; the fractioner only preserves the
    supplied ordered member set and proves structural integrity over it.
    """
