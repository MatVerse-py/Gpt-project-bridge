...
doc={'spdxVersion':'SPDX-2.3','dataLicense':'CC0-1.0','SPDXID':'SPDXRef-DOCUMENT','name':'GPT-Project-Bridge-declared-dependencies','documentNamespace':'https://github.com/MatVerse-py/Gpt-project-bridge/sbom/1.1.0','creationInfo':{'creators':['Tool: scripts/generate_sbom.py'],'created':'2026-07-27T00:00:00Z'},'packages':packages}
